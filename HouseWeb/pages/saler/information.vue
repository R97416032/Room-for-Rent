<template>
	<view>
		...
		<view style="width: 700rpx; height: 700rpx; margin-top: 20px; margin-left: 1200rpx;">
			...
			<view style="display: flex; margin-top: 30rpx;">
				...
				<input v-model="password" style="width: 400rpx; height: 80rpx; margin-top: 20rpx; margin-left: 10rpx; background-color:#F1F1F1" placeholder="请输入要修改的密码并确保3~20位"/>
			</view>
			<view style="display: flex; margin-top: 30rpx;">
...
export default {
	...
	methods: {
		goto(){
			...
			wx.request({
				url:'http://127.0.0.1:8080/user/updataUser',
				data:{
					account:uni.getStorageSync('userInfo').account,
					name:this.namexg,
					phone:this.phone,
