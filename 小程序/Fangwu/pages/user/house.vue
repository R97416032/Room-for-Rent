	...
	<view >
		...
		<view style="width: 100%; height: 0.1rpx; display: flex; border-radius: 10px;">
			<uni-collapse :accordion="true" style="width: 100%; display: flex; flex-direction:row">
				<uni-collapse-item title="位置距离" showAnimation="true" style="width: 260rpx;" >
				...
				<uni-collapse-item title="结构房型" showAnimation="true" style="width: 260rpx; " >
					<view style=" background-color: #FFFFFF;">
						<view style="width: 100%; height: 60rpx; text-align:center; background-color:#F8F8F8"  @click="search()">
				...
				<uni-collapse-item title="价格区间" showAnimation="true" style="width: 260rpx;" >
					<view style=" background-color: #FFFFFF;">
						<view style="display: flex;">
							<!-- <view style="font-size: 35rpx;">从: </view> -->
							<input style="height: 40rpx; width: 120rpx; margin-left: 50rpx; background-color: #E4E4E4;" v-model="pricemin" />
						</view>
						<text style="margin-left: 100rpx;">|</text>
						<view style="display: flex;">
						<!-- 	<view style="font-size: 35rpx;">到: </view> -->
							<input style="height: 40rpx; width: 120rpx; margin-left: 50rpx;  background-color: #E4E4E4;" v-model="pricemax" />
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			roomaddress(e){
				wx.request({
					url:'http://192.168.137.1:8081/user/getRoomsByAddress',
					data:{
						address:e
					},
					success: (response) => {
			...
			roomstructure(e){
				wx.request({
					url:'http://192.168.137.1:8081/user/getRoomsByStructure',
					data:{
						structure:e
					},
					success: (response) => {
			...
			roomprice(){
				wx.request({
					url:'http://192.168.137.1:8081/user/getRoomsByPrice',
					data:{
						min:this.pricemin,
						max:this.pricemax
					},
